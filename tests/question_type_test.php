...
namespace qtype_audio;

use qtype_audio;
use qtype_audio_edit_form;
...
class question_type_test extends \advanced_testcase {
    ...
    public function test_question_saving(): void {
        ...
        qtype_audio_edit_form::mock_submit((array)$formdata);

        $form = \qtype_audio_test_helper::get_question_editing_form($cat, $questiondata);
